...
def handle_client(client_sock):
    ...
    while True:
        ...
        try:
            data = client_sock.recv(netconstants.BUFFER_SIZE)  # TODO recvall?
...
if __name__ == '__main__':
    ...
    connection_sock.bind((netconstants.host, netconstants.PORT))
    connection_sock.listen(netconstants.SOCKET_BACKLOG)
    ...
    while True:
        ...
        try:
            ...
            # after each timeout.
            clientSock.settimeout(netconstants.SERVER_SOCKET_TIMEOUT)
