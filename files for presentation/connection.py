...
class Connection(threading.Thread):
    ...
    def run(self):
        ...
        self.socket.settimeout(netconstants.CLIENT_SOCKET_TIMEOUT)  # TODO Is there a better way than timeout?

        # Connect
        try:
            self.socket.connect((self.host, netconstants.PORT))
        except:
        ...
        while True:
            ...
            try:
                with self.socketLock:
                    data = self.socket.recv(netconstants.BUFFER_SIZE)
